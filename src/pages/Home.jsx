...
const MAIN_URL = "https://investigaciones.usc.edu.co/index.php/direccion-general-de-investgaciones"
...
const Home = () => {
    return (
        <HomeContainer>
            <SEO title="Dirección General de Investigaciones" description="La Dirección General de Investigaciones genera condiciones para favorecer los procesos investigativos y se encarga de coordinar la promoción, el desarrollo, el seguimiento y evaluación de la investigación." />
            ...
            <Card>
                La Universidad Santiago de Cali, consciente de su responsabilidad social en el aporte a la sociedad del conocimiento y en la formación integral de profesionales, fomenta la investigación en todo su ámbito y contribuye de esta forma al desarrollo de su entorno regional y nacional. Enmarcada en los propósitos de la Política Nacional de ciencia y Tecnología definidos por Colciencias y articulada a las agendas regionales de Ciencia y Tecnología prioriza la investigación aplicada, sin obviar la investigación básica realizando esfuerzos por transitar de una universidad con investigación hacia una universidad científica. La USC organiza su actividad investigadora a través de diferentes estructuras. Entre ellas se pueden citar los Departamentos académicos, los Centros de Investigación y/o Estudio en las diferentes Facultades y los Grupos de Investigación constituidos en torno a determinadas Líneas de Investigación. La Dirección General de Investigaciones genera condiciones para favorecer los procesos investigativos y se encarga de coordinar la promoción, el desarrollo, el seguimiento y evaluación de la investigación. La Comisión Central de Investigaciones, COCEIN, es el órgano asesor universitario a cargo de la definición de las políticas científicas universitarias, entre otras muchas funciones.
            </Card>

            <Card>
                <DirectorCard
                    image={"https://investigaciones.usc.edu.co/images/DGI/claudia-zuniga-canon.jpg"}
